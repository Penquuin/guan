...
void application::BaseApplication::createImage(uint32_t width, uint32_t height, uint32_t mipLevels,
...
void application::BaseApplication::copyBufferToImage(VkBuffer buffer, VkImage image, uint32_t width,
                                                     uint32_t height) {
    VkCommandBuffer commandBuffer = beginSingleTimeCommands();
...
void application::BaseApplication::transitionImageLayout(VkImage image, VkFormat format,
...
VkCommandBuffer application::BaseApplication::beginSingleTimeCommands() {
...
void application::BaseApplication::endSingleTimeCommands(VkCommandBuffer commandBuffer) {
...
VkImageView application::BaseApplication::createImageView(VkImage image, VkFormat format,
...
VkFormat application::BaseApplication::findSupportedFormat(const std::vector<VkFormat>& candidates,
...
VkFormat application::BaseApplication::findDepthFormat() {
    return findSupportedFormat(
        {VK_FORMAT_D32_SFLOAT, VK_FORMAT_D32_SFLOAT_S8_UINT, VK_FORMAT_D24_UNORM_S8_UINT},
        VK_IMAGE_TILING_OPTIMAL, VK_FORMAT_FEATURE_DEPTH_STENCIL_ATTACHMENT_BIT);
}

void application::BaseApplication::createDepthResources() {
