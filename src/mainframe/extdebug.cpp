...
#ifdef NDEBUG
const bool application::enableValidationLayers = false;
#else
const bool application::enableValidationLayers = true;
#endif

bool application::BaseApplication::isDeviceSuitable(VkPhysicalDevice device) {
...
bool application::BaseApplication::checkValidationLayerSupport() {
    uint32_t layerCount;
